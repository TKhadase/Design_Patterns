...
public class ClassLoader_Singleton_Solution {
	...
	try{
		...
		URLClassLoader loader = new URLClassLoader(new URL[] {new URL("File:\\E:\\c\\Design Patters JAVA\\SingletonClassLoaderTestJar.jar")}, 
				singleton.getClass().getClassLoader());//parent class loader.
